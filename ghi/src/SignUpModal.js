...
function SignUpModal() {
    ...
    const { show, username, password, full_name } = useSelector(state => state.account);
        ...
        <div className={modalClass} key="signup-modal">
            ...
            <div className="modal-content">
                <div className="box content">
                    ...
                    <form method="POST" onSubmit={preventDefault(signUp, () => ({ email: username, password, full_name }))}>
                        <div className="field">
                        ...
                        <div className="field">
                            ...
                            <div className="control">
                                <input required onChange={field} value={full_name} name="full_name" className="input" type="text" placeholder="Your Name" />
                            </div>
                        </div>
